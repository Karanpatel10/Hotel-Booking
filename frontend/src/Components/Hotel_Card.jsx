...
const Hotel_Card = ({room,index}) => {
  return (
    <Link to={'/rooms/'+room.id} onClick={()=>scrollTo(0,0)}  className='relative max-w-75 w-full rounded-xl overflow-hidden bg-white text-grey-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0.05)]'>
        <img src={room.images[0]} alt='' />
        {index%2 === 0 && <p className='px-3 py-1 absolute top-3 left-3 text-xl bg-white text-gray-800 font-medium rounded-full'>Best Seller</p>}
